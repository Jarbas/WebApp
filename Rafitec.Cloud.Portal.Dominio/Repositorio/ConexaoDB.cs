...
namespace Rafitec.Cloud.Portal.Dominio.Repositorio
{
    public class ConexaoDB : IDisposable
    {
        ...
        public ConexaoDB()
        {
            var conexaoString = ConfigurationManager.ConnectionStrings["EfDbContext"].ConnectionString;
            conexao = new OracleConnection(conexaoString);
        }
        ...
        private OracleCommand CriarComando(string comandoSQL, Dictionary<string, object> parametros)
        {
